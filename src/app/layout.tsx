          ...
          <nav style={{ borderBottom: "1px solid rgba(0,0,0,0.06)" }}>
            <div className="max-w-[1100px] mx-auto px-4 sm:px-6 h-12 flex items-center justify-between">
              ...
              <div className="flex items-center gap-4 sm:gap-6">
                <Link href="/#systems" className="hidden sm:inline text-xs font-medium uppercase tracking-wider hover:underline transition-all duration-100" style={{ color: "#4B5563" }}>{tNav("ventures")}</Link>
                <Link href="/#experience" className="hidden sm:inline text-xs font-medium uppercase tracking-wider hover:underline transition-all duration-100" style={{ color: "#4B5563" }}>{tNav("experience")}</Link>
                <Link href="/blog" className="text-xs font-medium uppercase tracking-wider hover:underline transition-all duration-100" style={{ color: "#4B5563" }}>{tNav("writing")}</Link>
          ...
          <footer className="mt-8" style={{ borderTop: "1px solid rgba(0,0,0,0.06)" }}>
            <div className="max-w-[1100px] mx-auto px-4 sm:px-6 py-6 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs" style={{ color: "#4B5563" }}>
              ...
              <div className="flex items-center flex-wrap justify-center gap-4 sm:gap-5">
                ...
                <a href="https://mentorcruise.com/mentor/kristynazackova/?utm_source=kristynazackova.com&utm_medium=portfolio&utm_campaign=footer" target="_blank" rel="noopener noreferrer" className="hover:underline transition-all duration-100 hover:text-black">{tFooter("mentorship")}</a>
