    ...
    <div className="max-w-2xl mx-auto px-6">
      ...
      <section className="pt-20 pb-16">
        ...
        <p className="text-muted text-lg leading-relaxed max-w-xl">
          Product leader building consumer-centric SaaS that solves complex
          advertising and incentives challenges for large CPG brands. Currently
          at{" "}
          <span className="text-foreground">Inmar Intelligence</span>. Finding
          efficiencies and personalizing experiences with AI.
        </p>
        <div className="flex gap-4 mt-8">
          <a
            ...
            className="text-sm text-muted hover:text-foreground transition-colors underline underline-offset-4 decoration-border hover:decoration-foreground"
          >
            LinkedIn
          </a>
          <a
      ...
      <section id="work" className="py-16">
        <h2 className="text-xs font-medium tracking-widest uppercase text-muted mb-10">
          Things I&apos;m building
        </h2>
            ...
            <div key={v.title}>
              <div className="flex items-baseline gap-3 mb-2">
                {v.link ? (
                  ...
                  >
                    {v.title}
                    <span className="text-muted ml-1.5">&nearr;</span>
                  </a>
                ) : (
        ...
        <div className="space-y-8">
          {experience.map((e, i) => (
            <div key={i} className="flex flex-col sm:flex-row sm:items-baseline gap-1 sm:gap-0">
              <span className="text-sm text-muted w-32 shrink-0 font-mono">
                {e.period}
              </span>
              <div>
      ...
      {/* Writing */}
      <section className="py-16">
        <h2 className="text-xs font-medium tracking-widest uppercase text-muted mb-4">
          Writing
        </h2>
