...
const ventures: Venture[] = [
  {
    ...
    status: "LIVE",
    why: "Regardless of the improvements in mental health awareness, people still struggle. They also struggle with talking to one another, and with seeking mental health support. People who do find that support need additional support ad hoc. There was no solution for this gap other than crisis call centers. I wanted to make mental health support more accessible: to people who don't feel comfortable sharing their struggles with another person, to those who do have support but lack guidance during the hardest moments that happen outside of the session, and to those who don't have the funds for human support.",
    description: "Selvenn is an AI life coaching platform supporting relationships, goals, and day-to-day life. It started as a conversation-analysis tool for couples and grew into a full coaching platform. Users talk to AI coach Lena through voice sessions and chat, upload files, journal, and complete personalized tasks. Selvenn provides insights, explains why those moments happen, and helps users improve. It also provides visibility into long-term improvement. The progress is gamified in a levelled journey, which unlocks deeper insights. Vision: Selvenn is an extension of our brain that helps us live mentally and physically better lives. Live with active users since November 2025.",
    media: [
