...
const ventures: Venture[] = [
  {
    ...
    status: "LIVE",
    why: "I saw a consistent gap in how people understand and improve their lives and relationships. Coaching and therapy can be valuable, but they are expensive, hard to access, and not embedded in the everyday moments where patterns actually form. I wanted to build a system that brings clarity to those moments: helping people see how they communicate, where friction and habits come from, and what to do about it next.",
    description: "Selvenn is an AI coach for the parts of life that matter most: your relationship, your goals, and your day-to-day. It started as a conversation-analysis tool for couples and grew into a full coaching platform. Users talk to Lena, the AI coach, through voice sessions and chat, upload real conversations for analysis, and keep a short journal. Selvenn connects all of it to surface the patterns, triggers, and habits people rarely catch on their own, then translates them into concrete daily exercises across 13 life areas, from relationships and dating to work, confidence, and mental well-being. Progress is structured as a levelled journey, so insight deepens as people put it into practice. Live with active users since November 2025.",
    media: [
